    ...
    public PaymentEvent newOrderEvent(OrderEvent orderEvent) {
        ...
        return userBalanceRepository.findById(orderRequestDto.getUserId())
                ...
                .map(userBalance -> {
                    ...
                    return new PaymentEvent(paymentRequestDto, PaymentStatusEnum.PAYMENT_COMPLETED);
                }).orElse(new PaymentEvent(paymentRequestDto, PaymentStatusEnum.PAYMENT_FAILED));
